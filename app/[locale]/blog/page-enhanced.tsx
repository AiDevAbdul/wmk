...
export default function BlogPageEnhanced() {
  ...
  return (
    <div className="min-h-screen bg-steel-dark overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 md:px-8 pb-24 z-10">
        {loading ? (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 auto-rows-max relative z-10"
          >
              ...
              <motion.div key={post.id} variants={itemVariants}>
                <Link href={`/${locale}/blog/${post.slug}`}>
                  <motion.div
                    ...
                    className="group relative min-h-96 bg-linear-to-br from-steel-mid/80 via-steel-mid/70 to-steel-dark/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-steel-light/20 hover:border-primary/60 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20 cursor-pointer"
                  >
